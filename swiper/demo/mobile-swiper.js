var mobileSwiper = function(selector) { 
	...
	transition = "transition: transform .3s ease", 
	css = [
		"z-index: 3; transform: translate3d(0, 0, 10px) scale3d(1, 1, 1); visibility: visible;", 
		"z-index: 2; transform: translate3d(" + rem(-148) + ", 0, 6px) scale3d(.8, .8, 1); visibility: visible;", 
		"z-index: 2; transform: translate3d(" + rem(148) + ", 0, 6px) scale3d(.8, .8, 1); visibility: visible;", 
		"z-index: 1; transform: translate3d(" + rem(-240) + ", 0, 2px) scale3d(.667, .667, 1); visibility: visible;", 
		"z-index: 1; transform: translate3d(" + rem(240) + ", 0, 2px) scale3d(.667, .667, 1); visibility: visible;"
	]; 

	this.init = function(list) {
		this.container = list; 
		list.style["transform-style"] = "preserve-3d"; 
